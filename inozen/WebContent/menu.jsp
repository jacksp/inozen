...
<html> 
	...
	<body>
		<div id="menu">
			...
			<ul>
				<li style="background: #c3ebf9 url(images/l1-inbox.png) no-repeat">
					<a href="javascript:void(0)" onclick="toggledisplay('appMenu');">메뉴 관리</a>
					<ul id="appMenu">
						<li><a href="admin/menu/main.do" target="content">메뉴 관리</a></li>
					</ul>
				</li>
			</ul>
			<ul>
			...
			<ul>
				<li style="background: #c3ebf9 url(images/l1-inbox.png) no-repeat">
					<a href="javascript:void(0)" onclick="toggledisplay('page');">페이지 관리</a>
					<ul id="page">
						<li><a href="admin/page/htmlList.do" target="content">페이지 관리</a></li>
					</ul>
				</li>
			</ul>
		</div>
