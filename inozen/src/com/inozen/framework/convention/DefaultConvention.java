 ...
 * 
 */
package com.inozen.framework.convention;

import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;

import com.inozen.framework.convention.exception.CannotLoadDomainClassException;
import com.inozen.framework.convention.exception.ConventionException;

/**
 * Default implementation of Convention.
 * @author seokhoon
 * @see com.inozen.framework.convention.Convention
 */
public class DefaultConvention implements Convention {
	
	public static Log logger = LogFactory.getLog(DefaultConvention.class);

	protected String domainPackageName = "com.inozen.framework.model";
	...
	public Class getDaoClassFromService(Class clazz) {
		...
		logger.debug("getDaoClassFromService:::"+serviceClassName);
		//TODO convention for service to dao
		//throw new UnsupportedOperationException();
		return getClass(domainPackageName + "." + 
				takeOffPrefixAndSuffix(serviceClassName, servicePrefix, serviceSuffix));
	}
